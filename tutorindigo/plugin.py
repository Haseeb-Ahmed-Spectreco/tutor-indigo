...
hooks.Filters.ENV_PATCHES.add_items(
    [
        ...
        (
            ...
            """
RUN npm install '@edx/brand@git+https://github.com/Haseeb-Ahmed-Spectreco/brand-edx.org.git#master'
RUN npm install '@edx/frontend-component-header@git+https://github.com/Haseeb-Ahmed-Spectreco/frontend-component-header.git#master'
